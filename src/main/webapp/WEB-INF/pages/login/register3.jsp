		...
		<div class="container">
			<form id="form1" class="form-horizontal" method="post"
				...
				<div class="form-group">
					<div class="col-xs-12">
						<div class="input-group">
							<span class="input-group-addon">爱车型号 <span
							...
							<input id="carType" name="carType" type="text"
								...
								data-bv-notempty-message="请选择爱车型号"> <input id="carBrand"
				...
				<div class="form-group">
					<div class="col-xs-12">
						<div class="input-group">
							<span class="input-group-addon">爱车款式 <span
								...
								data-bv-stringlength-message="爱车款式长度必须在2至20位之间" data-bv-notempty
								data-bv-notempty-message="请填写爱车款式">
						</div>
					</div>
				</div>
				<div class="form-group">
					<div class="col-xs-12">
						<div class="input-group">
							<span class="input-group-addon">爱车颜色 <span
								class="lfwer-seize">*</span></span> <select id="carColorList">
								<option value=''>-- 请选择爱车颜色 --</option>
								...
								data-bv-notempty data-bv-notempty-message="请选择爱车颜色"
