	...
	<div id="wrapperInfo">
		<div id="scrollerInfo">
			<div class="container">
				...
				<form id="addCarOwnerInfoForm" class="form-horizontal" method="post"
					action="${basePath }/carOwnerInfo/addCarOwnerInfoSubmit"
				...
				<%-- 	<div class="form-group">
					...
					<div class="form-group">
						<div class="col-xs-12">
							<div class="input-group">
								<span class="input-group-addon">联系电话</span><input readonly
									type="text" id="contacePhone" name="contacePhone"
									class="form-control" placeholder="请填写手机号" data-bv-notempty
					...
					<div class="form-group">
						<div class="col-xs-12">
							<div class="input-group">
								<span class="input-group-addon">车辆型号</span><input readonly
									type="text" id="carTypeName" name="carTypeName" class="form-control"
									style="border-radius: 0 3px 3px 0;" placeholder="请填写车辆型号"
									value="${carTypeName }" data-bv-stringlength
									data-bv-stringlength-min="1" data-bv-stringlength-max="20"
									data-bv-stringlength-message="车辆型号长度必须在1至20位之间"
									data-bv-notempty data-bv-notempty-message="请填写车辆型号">
									<input type="hidden" id="carType" name="carType" value="${carType }">
							</div>
						</div>
					</div>
					<div class="form-group">
						<div class="col-xs-12">
							<div class="input-group">
								<span class="input-group-addon">车辆款式</span><input readonly
									type="text" id="carStyle" name="carStyle" class="form-control"
									style="border-radius: 0 3px 3px 0;"
									placeholder="请填写车辆款式款式，如：2014款  自动旗舰型" value="${carStyle }"
									data-bv-stringlength data-bv-stringlength-min="2"
									data-bv-stringlength-max="20"
									data-bv-stringlength-message="车辆款式长度必须在2至20位之间"
									data-bv-notempty data-bv-notempty-message="请填写车辆款式">
							</div>
						</div>
					</div>
					<div class="form-group">
						<div class="col-xs-12">
							<div class="input-group">
								<span class="input-group-addon">车辆颜色</span><input readonly
									type="text" id="carColorName" name="carColorName" class="form-control"
									style="border-radius: 0 3px 3px 0;" placeholder="请填写车辆颜色"
									value="${carColorName }" data-bv-stringlength
									data-bv-stringlength-min="1" data-bv-stringlength-max="20"
									data-bv-stringlength-message="车辆颜色长度必须在1至20位之间"
									data-bv-notempty data-bv-notempty-message="请填写车辆颜色">
									<input type="hidden" id="carColor" name="carColor" value="${carColor }">
							</div>
						</div>
					</div> --%>
					<div class="form-group">
						<div class="col-xs-12">
							<div class="input-group">
								<span class="input-group-addon">出发地<span
									...
									data-bv-notempty-message="请选择出发地" class="form-control"
						...
						<div class="col-xs-12">
							<div class="input-group">
								<span class="input-group-addon">目的地<span
									class="lfwer-seize">⊙</span></span><select data-bv-notempty
									data-bv-notempty-message="请选择目的地" class="form-control"
					...
					<%-- <div class="form-group" id="divWeek" style="display: none;">
						<div class="col-xs-12">
							<div style="display: table;">
								<span class="input-group-addon">拼车周期</span>
								<div class="input-group lfwer-addon-radio-checkbox-control"
									style="border-radius: 0 3px 3px 0;">
									<div class="mini-checkboxlist"
										url="${basePath }/dict/getDicts?type=WEEK&pid=-1"
										textField="name" valueField="id"
										onvaluechanged="radioValueChg(e,'pweekName')"
										value="1,2,3,4,5"></div>
									<input name="pweekName" id="pweekName" type="text"
										class="lfwer-hidden" value="1,2,3,4,5" data-bv-notempty
					...
					<div class="form-group">
						<div class="col-xs-12">
							<div class="input-group">
								<span class="input-group-addon">途经地一</span><input type="text"
									id="via1" name="via1" class="form-control" data-bv-stringlength
									data-bv-stringlength-min="2" data-bv-stringlength-max="20"
									data-bv-stringlength-message="途经地一长度必须在2至20位之间">
							</div>
						</div>
					</div>
					<div class="form-group">
						<div class="col-xs-12">
							<div class="input-group">
								<span class="input-group-addon">途经地二</span><input type="text"
									id="via2" name="via2" class="form-control" data-bv-stringlength
									data-bv-stringlength-min="2" data-bv-stringlength-max="20"
									data-bv-stringlength-message="途经地二长度必须在2至20位之间">
							</div>
						</div>
					</div>
					<div class="form-group">
						<div class="col-xs-12">
							<div class="input-group">
								<span class="input-group-addon">途经地三</span><input type="text"
									id="via3" name="via3" class="form-control" data-bv-stringlength
									data-bv-stringlength-min="2" data-bv-stringlength-max="20"
									data-bv-stringlength-message="途经地三长度必须在2至20位之间">
							</div>
						</div>
					</div>
					<div class="form-group">
						<div class="col-xs-12">
							<div class="input-group">
								<span class="input-group-addon">途经地四</span><input type="text"
									id="via4" name="via4" class="form-control" data-bv-stringlength
									data-bv-stringlength-min="2" data-bv-stringlength-max="20"
									data-bv-stringlength-message="途经地四长度必须在2至20位之间">
							</div>
						</div>
					</div>
					<div class="form-group">
						<div class="col-xs-12">
							<div class="input-group">
								<span class="input-group-addon">途经地五</span><input type="text"
									id="via5" name="via5" class="form-control" data-bv-stringlength
									data-bv-stringlength-min="2" data-bv-stringlength-max="20"
									data-bv-stringlength-message="途经地五长度必须在2至20位之间">
							</div>
						</div>
					</div>
					<div class="form-group">
						<div class="col-xs-12">
							<div class="input-group btn-group">
								<span class="input-group-addon">可乘人数</span>
								...
								<input name="pnum" id="pnum" type="text" class="lfwer-hidden"
									value="1" data-bv-notempty data-bv-notempty-message="请选择可乘人数">
							</div>
						</div>
					</div>
					<div class="form-group">
						<div class="col-xs-12">
							<div class="input-group">
								<span class="input-group-addon">拼车价格</span><input type="text"
									...
									class="input-group-addon">元/人</span>
							</div>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group text-center">
						<div class="col-xs-12">
							<button type="button" id="btnSave" class="btn btn-primary btn-lg btn-block">发 布</button>
						</div>
					</div>
				</form>
				<div id="dtBox"></div>
			 ...
			 $.post($form.attr("action"),$form.serialize(),"json").done(function(result){
				 ...
				 if(result && result.valid == true){
						...
						$("#viewDiv").slideDown(500,function() {
							$("#viewDiv").load('${basePath}/carOwnerInfo/viewCarOwnerInfo?type=index&id='+ result.message, function() {
								$(".mask").hide();
							});
						});
				 }else{
